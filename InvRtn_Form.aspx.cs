...
namespace Dahboard_project
{
    public partial class InvRtn_Form : System.Web.UI.Page
    {
        ...
        protected void BtnUnPost_Click(object sender, EventArgs e)
        {
            ...
            List<object> keyValues = gvunPost.GetSelectedFieldValues("RtnInvid");
            ...
            cmd.CommandText = "GetZatcaRtnData";

            cmd.Parameters.Clear();
            cmd.Parameters.AddWithValue("@RtnInvid", keyValues[0].ToString());
            ...
            inv.billingReference.InvoiceDocumentReferenceID = keyValues[0].ToString();
            ...
            if (res.IsValid)
            {
                ...
                cmd.Parameters.Clear();
                cmd.Parameters.AddWithValue("@SType", "2" + CmbType2.Value.ToString());
